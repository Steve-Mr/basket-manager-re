...
public class PlayerStatisticsFragment extends BaseFragment {
    ...
    private void createPage() {
        ...
        if (statisticPlayerMatchResult.getMatches().intValue() > 0) {
            textView2.setText(String.valueOf(Util.round(statisticPlayerMatchResult.getMinutesPlayed().intValue() / statisticPlayerMatchResult.getMatches().intValue(), 1)) + " " + getHomeActivity().getString(R.string.player_statistics_minute));
        } else {
        ...
        if (statisticPlayerMatchResult.getMatches().intValue() > 0) {
            textView3.setText(BlankObj.toString(Double.valueOf(Util.round(statisticPlayerMatchResult.getPoints().intValue() / statisticPlayerMatchResult.getMatches().intValue(), 1))));
        } else {
        ...
        if (statisticPlayerMatchResult.getMatches().intValue() > 0) {
            textView4.setText(BlankObj.toString(Double.valueOf(Util.round(statisticPlayerMatchResult.getBlocks().doubleValue() / statisticPlayerMatchResult.getMatches().intValue(), 1))));
        } else {
        ...
        if (statisticPlayerMatchResult.getMatches().intValue() > 0) {
            textView5.setText(BlankObj.toString(Double.valueOf(Util.round(statisticPlayerMatchResult.getSteals().doubleValue() / statisticPlayerMatchResult.getMatches().intValue(), 1))));
        } else {
        ...
        if (statisticPlayerMatchResult.getMatches().intValue() > 0) {
            textView6.setText(BlankObj.toString(Double.valueOf(Util.round(statisticPlayerMatchResult.getRebounds().doubleValue() / statisticPlayerMatchResult.getMatches().intValue(), 1))));
        } else {
        ...
        if (statisticPlayerMatchResult.getMatches().intValue() > 0) {
            textView7.setText(BlankObj.toString(Double.valueOf(Util.round(statisticPlayerMatchResult.getPassesKo().doubleValue() / statisticPlayerMatchResult.getMatches().intValue(), 1))));
        } else {
        ...
        if (statisticPlayerMatchResult.getMatches().intValue() > 0) {
            textView8.setText(BlankObj.toString(Double.valueOf(Util.round(statisticPlayerMatchResult.getPassesOk().doubleValue() / statisticPlayerMatchResult.getMatches().intValue(), 1))));
        } else {
        ...
        if (statisticPlayerMatchResult.getShotOnePointTotals().intValue() > 0) {
            textView9.setText(BlankObj.toString(Double.valueOf(Util.round((statisticPlayerMatchResult.getShotOnePointOK().intValue() * 100) / statisticPlayerMatchResult.getShotOnePointTotals().intValue(), 1))));
        } else {
        ...
        if (statisticPlayerMatchResult.getShotTwoPointsTotals().intValue() > 0) {
            textView10.setText(BlankObj.toString(Double.valueOf(Util.round((statisticPlayerMatchResult.getShotTwoPointsOK().intValue() * 100) / statisticPlayerMatchResult.getShotTwoPointsTotals().intValue(), 1))));
        } else {
        ...
        if (statisticPlayerMatchResult.getShotThreePointsTotals().intValue() > 0) {
            textView11.setText(BlankObj.toString(Double.valueOf(Util.round((statisticPlayerMatchResult.getShotThreePointsOK().intValue() * 100) / statisticPlayerMatchResult.getShotThreePointsTotals().intValue(), 1))));
        } else {
