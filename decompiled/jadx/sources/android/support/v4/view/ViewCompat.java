...
public class ViewCompat {
    ...
    @IntDef({0, MediaStatus.COMMAND_PAUSE, MediaStatus.COMMAND_SEEK})
    private @interface AccessibilityLiveRegion {
    }

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({0, MediaStatus.COMMAND_PAUSE, MediaStatus.COMMAND_SEEK, MediaStatus.COMMAND_SET_VOLUME})
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({0, MediaStatus.COMMAND_PAUSE, MediaStatus.COMMAND_SEEK, 3})
    private @interface LayoutDirectionMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({0, MediaStatus.COMMAND_PAUSE, MediaStatus.COMMAND_PAUSE})
    private @interface OverScroll {
    }

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({0, MediaStatus.COMMAND_PAUSE})
