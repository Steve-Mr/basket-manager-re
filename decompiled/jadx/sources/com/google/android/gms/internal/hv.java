...
public interface hv extends IInterface {
    ...
    public static abstract class a extends Binder implements hv {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.hv$a$a, reason: collision with other inner class name */
        private static class C0059a implements hv {
            ...
            public void a(hu huVar, Uri uri, Bundle bundle, boolean z) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeStrongBinder(huVar != null ? huVar.asBinder() : null);
                    if (uri != null) {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    a(hu.a.aL(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
