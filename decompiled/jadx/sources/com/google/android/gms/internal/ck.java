...
public interface ck extends IInterface {
    ...
    public static abstract class a extends Binder implements ck {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.ck$a$a, reason: collision with other inner class name */
        private static class C0036a implements ck {
            private IBinder kn;
        ...
        public static ck m(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ck)) ? new C0036a(iBinder) : (ck) iInterfaceQueryLocalInterface;
        }
