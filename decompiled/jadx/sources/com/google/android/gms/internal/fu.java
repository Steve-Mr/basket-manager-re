...
public class fu<K, V> {
    ...
    public final synchronized String toString() {
        ...
        synchronized (this) {
            ...
            str = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.DM), Integer.valueOf(this.DQ), Integer.valueOf(this.DR), Integer.valueOf(i != 0 ? (this.DQ * 100) / i : 0));
        }
        return str;
    }
    ...
    */
    public void trimToSize(int r5) {
        ...
        L0:
            ...
            if (r0 < 0) goto L11
            java.util.LinkedHashMap<K, V> r0 = r4.DL     // Catch: java.lang.Throwable -> L32
        ...
        L43:
            ...
            java.util.LinkedHashMap<K, V> r2 = r4.DL     // Catch: java.lang.Throwable -> L32
            ...
            int r2 = r4.DP     // Catch: java.lang.Throwable -> L32
            int r2 = r2 + 1
            r4.DP = r2     // Catch: java.lang.Throwable -> L32
            monitor-exit(r4)     // Catch: java.lang.Throwable -> L32
            r2 = 1
            r3 = 0
