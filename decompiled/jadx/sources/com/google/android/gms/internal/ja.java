...
public interface ja extends IInterface {
    ...
    public static abstract class a extends Binder implements ja {

        /* JADX INFO: renamed from: com.google.android.gms.internal.ja$a$a, reason: collision with other inner class name */
        private static class C0062a implements ja {
            private IBinder kn;
        ...
        public static ja aT(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ja)) ? new C0062a(iBinder) : (ja) iInterfaceQueryLocalInterface;
        }
