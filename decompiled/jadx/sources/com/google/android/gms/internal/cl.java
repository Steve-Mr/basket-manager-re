...
public interface cl extends IInterface {
    ...
    public static abstract class a extends Binder implements cl {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.cl$a$a, reason: collision with other inner class name */
        private static class C0037a implements cl {
            private IBinder kn;
        ...
        public static cl n(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof cl)) ? new C0037a(iBinder) : (cl) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder iBinderA = a(d.a.K(data.readStrongBinder()));
