...
public interface cn extends IInterface {
    ...
    public static abstract class a extends Binder implements cn {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.cn$a$a, reason: collision with other inner class name */
        private static class C0038a implements cn {
            private IBinder kn;
        ...
        public static cn o(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof cn)) ? new C0038a(iBinder) : (cn) iInterfaceQueryLocalInterface;
        }
