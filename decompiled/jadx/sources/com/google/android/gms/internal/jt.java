...
public class jt implements Parcelable.Creator<js> {
    static void a(js jsVar, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.b.c(parcel, 1, jsVar.getVersionCode());
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 2, jsVar.adn, false);
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 3, jsVar.pm, false);
    ...
    public js createFromParcel(Parcel parcel) {
        ...
        return new js(iG, strN2, strN);
    }

    @Override // android.os.Parcelable.Creator
    /* JADX INFO: renamed from: cI, reason: merged with bridge method [inline-methods] */
