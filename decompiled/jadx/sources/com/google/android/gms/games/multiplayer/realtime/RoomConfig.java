...
public final class RoomConfig {
    ...
    public static final class Builder {
        ...
        private Builder(RoomUpdateListener updateListener) {
            ...
            this.MP = false;
            this.MK = (RoomUpdateListener) fq.b(updateListener, "Must provide a RoomUpdateListener");
        }
        ...
        public Builder setVariant(int variant) {
            fq.b(variant == -1 || variant > 0, "Variant must be a positive integer or Room.ROOM_VARIANT_ANY");
            this.My = variant;
            return this;
        }
    }
