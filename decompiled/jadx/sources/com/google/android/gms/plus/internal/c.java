...
public interface c extends IInterface {
    ...
    public static abstract class a extends Binder implements c {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.plus.internal.c$a$a, reason: collision with other inner class name */
        ...
        public static c aP(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof c)) ? new C0111a(iBinder) : (c) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    com.google.android.gms.dynamic.d dVarA = a(d.a.K(data.readStrongBinder()), data.readInt(), data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeStrongBinder(dVarA != null ? dVarA.asBinder() : null);
                    return true;
                case 2:
                    data.enforceInterface("com.google.android.gms.plus.internal.IPlusOneButtonCreator");
                    com.google.android.gms.dynamic.d dVarA2 = a(d.a.K(data.readStrongBinder()), data.readInt(), data.readInt(), data.readString(), data.readString());
                    reply.writeNoException();
