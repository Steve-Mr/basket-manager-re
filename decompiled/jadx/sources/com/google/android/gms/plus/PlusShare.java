...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            fq.a(plusClient != null, "PlusClient must not be null.");
            fq.a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            fq.a(plusClient.iI().bg(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            ...
            fq.b((uri == null || TextUtils.isEmpty(uri.toString())) ? false : true, "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                fq.a(PlusShare.bd(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            fq.a((z2 && booleanExtra) ? false : true, "Call-to-action buttons are only available for URLs.");
            fq.a(!booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL), "The content URL is required for interactive posts.");
            ...
            fq.a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                fq.a(PlusShare.bd(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && zEquals) {
                ...
                if (this.Ua == null || this.Ua.isEmpty()) {
                    ...
                    this.mIntent.putExtra("android.intent.extra.STREAM", this.Ua.get(0));
                }
                this.Ua = null;
            }
            if (z2 && !zEquals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            ...
            fq.b(!TextUtils.isEmpty(deepLinkId), "The deepLinkId parameter is required.");
            Bundle bundleA = PlusShare.a(title, description, thumbnailUri);
            this.mIntent.putExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID, deepLinkId);
            this.mIntent.putExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_METADATA, bundleA);
            this.mIntent.setType("text/plain");
            return this;
        }
