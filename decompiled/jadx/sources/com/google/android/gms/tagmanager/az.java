...
class az extends aj {
    ...
    private static final String Ym = com.google.android.gms.internal.b.ITEM_SEPARATOR.toString();
    private static final String Yn = com.google.android.gms.internal.b.KEY_VALUE_SEPARATOR.toString();
    private static final String Yo = com.google.android.gms.internal.b.ESCAPE.toString();
    ...
    */
    private java.lang.String a(java.lang.String r6, com.google.android.gms.tagmanager.az.a r7, java.util.Set<java.lang.Character> r8) {
        /*
            r5 = this;
            int[] r0 = com.google.android.gms.tagmanager.az.AnonymousClass1.Yp
            int r1 = r7.ordinal()
            r0 = r0[r1]
            switch(r0) {
                case 1: goto Lc;
        ...
        Lb:
            return r6
        Lc:
            java.lang.String r6 = com.google.android.gms.tagmanager.dk.cd(r6)     // Catch: java.io.UnsupportedEncodingException -> L11
            goto Lb
        L11:
            r0 = move-exception
    ...
    public d.a x(Map<String, d.a> map) {
        HashSet hashSet;
        a aVar;
        d.a aVar2 = map.get(XQ);
        if (aVar2 == null) {
            return dh.lT();
        }
        d.a aVar3 = map.get(Ym);
        String strJ = aVar3 != null ? dh.j(aVar3) : "";
        d.a aVar4 = map.get(Yn);
        String strJ2 = aVar4 != null ? dh.j(aVar4) : "=";
        a aVar5 = a.NONE;
        d.a aVar6 = map.get(Yo);
        if (aVar6 != null) {
            String strJ3 = dh.j(aVar6);
            if (PlusShare.KEY_CALL_TO_ACTION_URL.equals(strJ3)) {
                aVar = a.URL;
                hashSet = null;
            } else {
                if (!"backslash".equals(strJ3)) {
                    bh.w("Joiner: unsupported escape type: " + strJ3);
                    return dh.lT();
                }
                aVar = a.BACKSLASH;
                hashSet = new HashSet();
        ...
        switch (aVar2.type) {
            ...
            case 3:
                for (int i2 = 0; i2 < aVar2.fP.length; i2++) {
                    ...
                    String strJ4 = dh.j(aVar2.fP[i2]);
                    String strJ5 = dh.j(aVar2.fQ[i2]);
