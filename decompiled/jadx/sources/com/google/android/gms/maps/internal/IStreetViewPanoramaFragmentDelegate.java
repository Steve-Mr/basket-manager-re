...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate$a$a, reason: collision with other inner class name */
        private static class C0078a implements IStreetViewPanoramaFragmentDelegate {
            private IBinder kn;
            ...
            public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
                ...
                try {
                    ...
                    return IStreetViewPanoramaDelegate.a.ax(parcelObtain2.readStrongBinder());
                } finally {
            ...
            @Override // com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate
            public com.google.android.gms.dynamic.d onCreateView(com.google.android.gms.dynamic.d inflaterWrapper, com.google.android.gms.dynamic.d containerWrapper, Bundle savedInstanceState) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
            ...
            @Override // com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate
            public void onInflate(com.google.android.gms.dynamic.d activityWrapper, StreetViewPanoramaOptions options, Bundle savedInstanceState) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
        ...
        public static IStreetViewPanoramaFragmentDelegate ay(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IStreetViewPanoramaFragmentDelegate)) ? new C0078a(iBinder) : (IStreetViewPanoramaFragmentDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onInflate(d.a.K(data.readStrongBinder()), data.readInt() != 0 ? StreetViewPanoramaOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    com.google.android.gms.dynamic.d dVarOnCreateView = onCreateView(d.a.K(data.readStrongBinder()), d.a.K(data.readStrongBinder()), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    reply.writeStrongBinder(dVarOnCreateView != null ? dVarOnCreateView.asBinder() : null);
                    return true;
                case 5:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onResume();
    ...
    com.google.android.gms.dynamic.d onCreateView(com.google.android.gms.dynamic.d dVar, com.google.android.gms.dynamic.d dVar2, Bundle bundle) throws RemoteException;

    void onDestroy() throws RemoteException;

    void onDestroyView() throws RemoteException;

    void onInflate(com.google.android.gms.dynamic.d dVar, StreetViewPanoramaOptions streetViewPanoramaOptions, Bundle bundle) throws RemoteException;
