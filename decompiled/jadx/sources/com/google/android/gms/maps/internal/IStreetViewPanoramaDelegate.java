...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IStreetViewPanoramaDelegate {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate$a$a, reason: collision with other inner class name */
        private static class C0077a implements IStreetViewPanoramaDelegate {
            private IBinder kn;
        ...
        public static IStreetViewPanoramaDelegate ax(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IStreetViewPanoramaDelegate)) ? new C0077a(iBinder) : (IStreetViewPanoramaDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 18:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    StreetViewPanoramaOrientation streetViewPanoramaOrientationPointToOrientation = pointToOrientation(d.a.K(parcel.readStrongBinder()));
                    parcel2.writeNoException();
