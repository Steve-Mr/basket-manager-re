...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IProjectionDelegate {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.maps.internal.IProjectionDelegate$a$a, reason: collision with other inner class name */
        private static class C0076a implements IProjectionDelegate {
            private IBinder kn;
            ...
            public LatLng fromScreenLocation(com.google.android.gms.dynamic.d point) throws RemoteException {
            ...
            @Override // com.google.android.gms.maps.internal.IProjectionDelegate
            public com.google.android.gms.dynamic.d toScreenLocation(LatLng location) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.maps.internal.IProjectionDelegate");
        ...
        public static IProjectionDelegate av(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IProjectionDelegate)) ? new C0076a(iBinder) : (IProjectionDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    LatLng latLngFromScreenLocation = fromScreenLocation(d.a.K(data.readStrongBinder()));
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    com.google.android.gms.dynamic.d screenLocation = toScreenLocation(data.readInt() != 0 ? LatLng.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
    ...
    LatLng fromScreenLocation(com.google.android.gms.dynamic.d dVar) throws RemoteException;

    VisibleRegion getVisibleRegion() throws RemoteException;

    com.google.android.gms.dynamic.d toScreenLocation(LatLng latLng) throws RemoteException;
}
