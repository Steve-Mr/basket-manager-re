...
public interface i extends IInterface {
    ...
    public static abstract class a extends Binder implements i {
        ...
        private static class C0088a implements i {
            private IBinder kn;
        ...
        public static i al(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof i)) ? new C0088a(iBinder) : (i) iInterfaceQueryLocalInterface;
        }
