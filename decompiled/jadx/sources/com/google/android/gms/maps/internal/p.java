...
public interface p extends IInterface {
    ...
    public static abstract class a extends Binder implements p {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.maps.internal.p$a$a, reason: collision with other inner class name */
        private static class C0095a implements p {
            private IBinder kn;
        ...
        public static p as(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof p)) ? new C0095a(iBinder) : (p) iInterfaceQueryLocalInterface;
        }
