...
public class a {
    ...
    public static class C0019a extends RuntimeException {
        public C0019a(String str, Parcel parcel) {
    ...
    private static void a(Parcel parcel, int i, int i2) {
        int iA = a(parcel, i);
        if (iA != i2) {
            throw new C0019a("Expected size " + i2 + " got " + iA + " (0x" + Integer.toHexString(iA) + ")", parcel);
        }
    }

    private static void a(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            throw new C0019a("Expected size " + i3 + " got " + i2 + " (0x" + Integer.toHexString(i2) + ")", parcel);
        }
    }
    ...
    public static int o(Parcel parcel) {
        ...
        int iDataPosition = parcel.dataPosition();
        if (R(iN) != 20293) {
            throw new C0019a("Expected object header. Got 0x" + Integer.toHexString(iN), parcel);
        }
        int i = iDataPosition + iA;
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new C0019a("Size read is invalid start=" + iDataPosition + " end=" + i, parcel);
        }
        return i;
    }
