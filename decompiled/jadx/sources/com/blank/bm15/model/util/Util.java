...
public class Util {
    ...
    public static double round(double number, int decimals) {
        ...
        return Math.rint(((double) aux) * number) / ((double) aux);
    }

    public static Integer getRandomValue(Integer minValue, Integer maxValue) {
        return Integer.valueOf((int) Math.floor((Math.random() * ((double) ((maxValue.intValue() - minValue.intValue()) + 1))) + ((double) minValue.intValue())));
    }
    ...
    public static Double getRandomSimulate(Double base) {
        ...
        double result = ((double) list.get(1).intValue()) / 10.0d;
    ...
    public static Integer getSalary(Player player) {
        ...
        double value = (120.0d * (((((subAverage * subAverage) * subAverage) * subAverage) / 400.0d) * ((double) (((40 - player.getAge().intValue()) + (player.getPotential().intValue() * 2)) + 75)))) / 100.0d;
