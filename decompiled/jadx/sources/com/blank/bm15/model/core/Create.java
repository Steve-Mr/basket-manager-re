...
public class Create {
    ...
    private static void createAllPlayers(Game game, List<Team> teamList, InputStream is) throws Throwable {
    ...
    private static List<Player> createPlayersByFile(Game game, InputStream is) throws Throwable {
        ...
        try {
            value = null;
            fields = BlankDao.getOrderedFields(new Roster(game.getContext()));
        } catch (Exception e2) {
            e = e2;
            reader2 = reader;
    ...
    private static <T extends BlankBase> void createRostersFile(List<T> list) throws Throwable {
        if (!list.isEmpty()) {
            T obj = list.get(0);
