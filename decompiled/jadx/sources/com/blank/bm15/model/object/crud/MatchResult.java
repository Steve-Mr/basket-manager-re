...
public class MatchResult extends BlankBase {
    ...
    public Integer getPoints() {
        double points = 0.0d + ((double) (getShotsFreeOkInt().intValue() * 1));
        return BlankObj.toInteger(Double.valueOf(points + ((double) (getShotsInteriorOkInt().intValue() * 2)) + ((double) (getShotsExteriorDoubleOkInt().intValue() * 2)) + ((double) (getShotsExteriorTripleOkInt().intValue() * 3))));
    }

    public Double getPer() {
        double per = getMinutesPlayed().intValue() > 0 ? ((double) ((((((((((((getStealsInt().intValue() * 54) + (getShotsExteriorTripleOkInt().intValue() * 52)) + ((getShotsInteriorOkInt().intValue() + getShotsExteriorDoubleOkInt().intValue()) * 85)) + (getShotsFreeOkInt().intValue() * 47)) + (getBlocksInt().intValue() * 39)) + (getPassesOkInt().intValue() * 35)) + (getReboundsInt().intValue() * 27)) - (getFoulsMadeInt().intValue() * 17)) - (getShotsFreeKoInt().intValue() * 20)) - ((getShotsInteriorKoInt().intValue() + getShotsExteriorDoubleKoInt().intValue()) * 39)) - (getShotsExteriorTripleKoInt().intValue() * 39)) - (getPassesKoInt().intValue() * 54))) / ((double) getMinutesPlayed().intValue()) : -100.0d;
