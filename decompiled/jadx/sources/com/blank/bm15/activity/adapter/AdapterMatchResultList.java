        ...
        if (position > 0) {
            ...
            if (matchResult.getMatches().intValue() > 0) {
                if (matchResult.getName() == null) {
                    ...
                    holder.textViewMinutes.setText(BlankObj.toString(Double.valueOf(Util.round(((double) matchResult.getMinutesPlayed().intValue()) / ((double) matchResult.getMatches().intValue()), 1))));
                }
                ...
                if (matchResult.getMatches().intValue() == 1) {
                    ...
                    holder.textViewPoints.setText(BlankObj.toString(Double.valueOf(Util.round(((double) matchResult.getPoints().intValue()) / ((double) matchResult.getMatches().intValue()), 1))));
                    holder.textViewRebounds.setText(BlankObj.toString(Double.valueOf(Util.round(((double) matchResult.getReboundsInt().intValue()) / ((double) matchResult.getMatches().intValue()), 1))));
                    holder.textViewPassOK.setText(BlankObj.toString(Double.valueOf(Util.round(((double) matchResult.getPassesOkInt().intValue()) / ((double) matchResult.getMatches().intValue()), 1))));
                    holder.textViewBlocks.setText(BlankObj.toString(Double.valueOf(Util.round(((double) matchResult.getBlocksInt().intValue()) / ((double) matchResult.getMatches().intValue()), 1))));
                    holder.textViewSteals.setText(BlankObj.toString(Double.valueOf(Util.round(((double) matchResult.getStealsInt().intValue()) / ((double) matchResult.getMatches().intValue()), 1))));
                }
