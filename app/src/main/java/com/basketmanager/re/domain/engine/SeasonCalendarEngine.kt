...
object SeasonCalendarEngine {
    ...
    fun generateSeasonSchedule(gameId: Long, teams: List<Team>): List<Match> {
        ...
        val eastTeams = byConference[com.basketmanager.re.domain.model.Conference.EAST] ?: emptyList()
        val westTeams = byConference[com.basketmanager.re.domain.model.Conference.WEST] ?: emptyList()
